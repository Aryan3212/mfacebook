...
//         }
//     ]
//     await it('should return all Posts sorted by timestamp', async () => {
//         const requestUrl = baseUrl + 'Posts/';
//         const response = await fetch(requestUrl);
//         const body = await response.json()
//         assert.equal(response.status, 200);
//         assert.deepEqual(body, allPosts);
//     })
//     await it('should return all Posts from users I follow', async () => {
//         const requestUrl = baseUrl + 'users/1/Posts/following/';
//         const response = await fetch(requestUrl);
//         const body = await response.json()
//         assert.equal(response.status, 200);
//         assert.deepEqual(body, followingPosts);
//     })
//     await it('should return all Posts that I posted', async () => {
//         const requestUrl = baseUrl + 'users/1/Posts/';
//         const response = await fetch(requestUrl);
//         const body = await response.json()
//         assert.equal(response.status, 200);
//         assert.deepEqual(body, postedPosts);
//     })
